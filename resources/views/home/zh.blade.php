...
@section('content')
    <div class="row">
        <div id="showcase" class="col">
            ...
            <div class="mt-5">
                <p><a href="{{ url('/') }}">Русский</a> | <a href="{{ url('/en') }}">English</a> | 中文</p>
            </div>
            <div class="mt-3">
                <p>你有没有想过买下所有 Steam 游戏要花多少钱？</p>
                <p>截至目前，Steam 所有游戏打折后的价格为 <span class="text-danger">RUB {{ $record->sale }}</span>，而原价则为 <span
                            class="text-danger">RUB {{ $record->original }}</span>。</p>
